            ...
            <ul class="lista-odpowiedzi" role="list">
                <li>
                    <div class="pojedyncza-odpowiedz" role="checkbox" tabindex="0"
                        :aria-checked="zaznaczenieOdpowiedzi1" @click="is_krzyzyk1 = true,
                            is_krzyzyk2 = false,
                            is_krzyzyk3 = false,
                ...
                <li>
                    <div class="pojedyncza-odpowiedz" role="checkbox" tabindex="0"
                        :aria-checked="zaznaczenieOdpowiedzi2" @click="is_krzyzyk2 = true,
                            is_krzyzyk1 = false,
                            is_krzyzyk3 = false,
                            if_button_dalej = true,
                ...
                <li>
                    <div class="pojedyncza-odpowiedz" role="checkbox" tabindex="0"
                        :aria-checked="zaznaczenieOdpowiedzi3" @click="is_krzyzyk3 = true,
                            is_krzyzyk1 = false,
                            is_krzyzyk2 = false,
                            if_button_dalej = true,
